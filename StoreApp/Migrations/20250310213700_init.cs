        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, 1, "/images/6.jpg", 300m, "Tool Cook Book", false, "" },
                    { 7, 1, "/images/7.jpg", 400m, "History Book", false, "" },
                    { 8, 1, "/images/8.jpg", 90m, "Xp-Pen", true, "" },
                    { 9, 2, "/images/9.jpg", 20900m, "Some another Phone", true, "" },
                    { 10, 1, "/images/10.jpg", 6000m, "Luxury Mouse", true, "" }
                });
